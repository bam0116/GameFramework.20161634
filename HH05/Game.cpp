	...
	int width, int height, bool fullscreen)
{
	if (SDL_Init(SDL_INIT_EVERYTHING) >= 0)
	{
		...
		if (!TheTextureManager::Instance()->load("Assets/Megaman.png", "Megaman", m_pRenderer))
		{
			return false;
		}
		if (!TheTextureManager::Instance()->load("Assets/llama.png", "llama", m_pRenderer))
		{
			return false;
		}
		...
		m_monster->load(100, 200, 122, 112, "Megaman");
		m_enemy->load(0, 0, 124, 128, "llama");
